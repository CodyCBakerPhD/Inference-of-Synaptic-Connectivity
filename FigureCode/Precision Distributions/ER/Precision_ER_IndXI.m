...
SimPar = LoadBaseSimPar('Pyle2016_RealPart','ER','direct',N,T, 'Pscale',2, 'warn',false);
...
%% Unlabeled ROC curve
ConnTypeROC = GetConnTypeROC(prec,BiDirIds,true);


%% EI Type ROC curves
EITypeROC = GetEITypeROCs(prec,BiDirIds,true,true);
